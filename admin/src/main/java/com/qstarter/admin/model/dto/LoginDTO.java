...
public class LoginDTO {
    ...
    @Length(min = CommonArgumentsValidConstant.PASSWORD_LENGTH_MIN, max = CommonArgumentsValidConstant.PASSWORD_LENGTH_MAX, message = CommonArgumentsValidConstant.PASSWORD_VALID_MESSAGE)
