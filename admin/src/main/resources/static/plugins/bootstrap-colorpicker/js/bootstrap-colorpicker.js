...
exports.default = {
  ...
  horizontal: false,
  /**
   * Forces to showTab the colorpicker as an inline element.
   *
...
/**
 * Handles everything related to the UI of the colorpicker popup: showTab, hide, position,...
 * @ignore
 */
var PopupHandler = function () {
  ...
  _createClass(PopupHandler, [{
    ...
    /**
     * Binds the different colorpicker elements to the focus/mouse/touch events so it reacts in order to showTab or
    ...
    value: function bind() {
      ...
      if (cp.options.inline) {
        ...
        return; // no need to bind showTab/hide events for inline elements
      }
      ...
      // bind addon showTab/hide events
      if (this.hasAddon) {
      ...
      // bind input showTab/hide events
      if (this.hasInput && !this.hasAddon) {
        this.input.on({
    ...
    value: function fireShow() {
      ...
      /**
       * (Colorpicker) When showTab() is called and the widget can be shown.
       *
